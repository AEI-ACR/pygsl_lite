...
PyGSL_convert_to_gsl_function(PyObject * object)
{
     ...
     FUNC_MESS_BEGIN();
     params = PyGSL_convert_to_generic_function(object, NULL, NULL, pygsl_lite_gsl_function);
     if(params == NULL){
	  return NULL;
     }
...
PyGSL_convert_to_gsl_function_fdf(PyObject * object)
{
     ...
     params = PyGSL_convert_to_generic_function_fdf(object, NULL, NULL,
					      pygsl_lite_gsl_f_function, pygsl_lite_gsl_df_function, pygsl_lite_gsl_fdf_function);
     if(params == NULL){
	  return NULL;
     }
...
PyGSL_convert_to_gsl_multiroot_function(PyObject * object)
{
     ...
     FUNC_MESS_BEGIN();
     params = PyGSL_convert_to_generic_function(object, &size, NULL, pygsl_lite_multiroot_function);
     if(params == NULL){
	  return NULL;
     }
...
PyGSL_convert_to_gsl_multiroot_function_fdf(PyObject * object){
     ...
     int size;
     FUNC_MESS_BEGIN();
     params = PyGSL_convert_to_generic_function_fdf(object, &size, NULL, pygsl_lite_multiroot_f_function,
					      pygsl_lite_multiroot_df_function,
					      pygsl_lite_multiroot_fdf_function);
     if(params == NULL){
	  return NULL;
     }
...
PyGSL_convert_to_gsl_multimin_function(PyObject * object)
{
     ...
     FUNC_MESS_BEGIN();
     params = PyGSL_convert_to_generic_function(object, &size, NULL, pygsl_lite_multimin_function);
     if(params == NULL){
	  return NULL;
     }
...
PyGSL_convert_to_gsl_multimin_function_fdf(PyObject * object){
     ...
     FUNC_MESS_BEGIN();
     params = PyGSL_convert_to_generic_function_fdf(object, &size, NULL, pygsl_lite_multimin_f_function,
					      pygsl_lite_multimin_df_function, pygsl_lite_multimin_fdf_function);
     if(!params){
	  return NULL;
     }
...
PyGSL_convert_to_gsl_multifit_function(PyObject * object)
{
     ...
     FUNC_MESS_BEGIN();
     params = PyGSL_convert_to_generic_function(object, &n, &p, pygsl_lite_multifit_function);
     if(params == NULL){
	  return NULL;
     }
...
PyGSL_convert_to_gsl_multifit_function_fdf(PyObject * object){
     ...
     FUNC_MESS_BEGIN();
     params = PyGSL_convert_to_generic_function_fdf(object, &n, &p, pygsl_lite_multifit_f_function,
					      pygsl_lite_multifit_df_function, pygsl_lite_multifit_fdf_function);
     if(params == NULL){
	  return NULL;
     }
...
PyGSL_convert_to_gsl_monte_function(PyObject * object)
{
     ...
     FUNC_MESS_BEGIN();
     params = PyGSL_convert_to_generic_function(object, &n, NULL, pygsl_lite_monte_function);
     if(params == NULL){
	  return NULL;
     }

...
#define PyGSL_PyCOMPLEX_TO_gsl_complex(object, tmp) PyGSL_PyComplex_to_gsl_complex(object, tmp)
#define PyGSL_PyCOMPLEX_TO_gsl_complex_float(object, tmp) PyGSL_PyComplex_to_gsl_complex_float(object, tmp)
#define PyGSL_PyCOMPLEX_TO_gsl_complex_long_double(object, tmp) PyGSL_PyComplex_to_gsl_complex_long_double(object, tmp)
